...
(function (window, document, $) {
  ...
  $('[data-popup=popover-color]').popover({
    template: '<div class="popover"><div class="bg-primary"><div class="popover-arrow"></div><div class="popover-inner"></div></div></div>'
  });

  //-------------- Custom borer color --------------
  $('[data-popup=popover-border]').popover({
    template: '<div class="popover"><div class="border-warning"><div class="popover-arrow"></div><div class="popover-inner"></div></div></div>'
  });
